...
DEMO_SIDE_SEC = 2.0
MIN_ACTION_DURATION = 0.8  # 最小動作時間（秒）
MAX_ACTION_DURATION = 6.0  # 最大動作時間（秒）
R_DEMO = 0.3  # 門檻 = DEMO 能量的倍數
...
def analyze_csv(file_path: str, cutoff: float = 0.8, order: int = 4,
    ...
    try:
        ...
        if demo_E < MIN_DEMO_ENERGY:
            ...
            energy_threshold = 0.15 * std_main
...
# 打開註解(電腦版) - 畫圖函數
def plot_sip_analysis(csv_path, t_all, r_all, r_all_detrend, t, r_filt, baseline, r_detrend,
...
if __name__ == "__main__":
    # 直接列出所有要分析的檔案
    csv_files = [
r"C:\Users\plus1\Downloads\1118從S24取出資料_分類\SIP_LIPS\FaceTraining_SIP_LIPS_20251103_175603.csv",
r"C:\Users\plus1\Downloads\1118從S24取出資料_分類\SIP_LIPS\FaceTraining_SIP_LIPS_20251103_140958.csv",
r"C:\Users\plus1\Downloads\1118從S24取出資料_分類\SIP_LIPS\FaceTraining_SIP_LIPS_20251102_190714.csv",
r"C:\Users\plus1\Downloads\1118從S24取出資料_分類\SIP_LIPS\FaceTraining_SIP_LIPS_20251117_184358.csv",
r"C:\Users\plus1\Downloads\1118從S24取出資料_分類\SIP_LIPS\FaceTraining_SIP_LIPS_20251113_145556.csv",
r"C:\Users\plus1\Downloads\1118從S24取出資料_分類\SIP_LIPS\FaceTraining_SIP_LIPS_20251104_035124.csv"
    ]
