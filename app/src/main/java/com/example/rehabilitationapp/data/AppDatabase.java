...
public abstract class AppDatabase extends RoomDatabase {
    ...
    // ★ 新增 Migration: 7 -> 8（在 trainingHistory 加 saved 和 selfReportCount）
    public static final Migration MIGRATION_7_8 = new Migration(7, 8) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase db) {
            db.execSQL("ALTER TABLE trainingHistory ADD COLUMN saved INTEGER NOT NULL DEFAULT 0");
            db.execSQL("ALTER TABLE trainingHistory ADD COLUMN selfReportCount INTEGER NOT NULL DEFAULT -1");
        }
    };

    // ★ 新增 Migration: 8 -> 9（在 trainingHistory 加 csvUploaded 和 csvFileName）
    public static final Migration MIGRATION_8_9 = new Migration(8, 9) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase db) {
            db.execSQL("ALTER TABLE trainingHistory ADD COLUMN csvUploaded INTEGER NOT NULL DEFAULT 0");
            db.execSQL("ALTER TABLE trainingHistory ADD COLUMN csvFileName TEXT NOT NULL DEFAULT ''");
        }
    };
